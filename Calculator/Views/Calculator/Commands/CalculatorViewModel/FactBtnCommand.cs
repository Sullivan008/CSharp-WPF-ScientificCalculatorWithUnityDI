...
namespace Calculator.Views.Calculator.ViewModels
{
    ...
    {
        private ICommand _factBtnCommand;
        public ICommand FactBtnCommand =>
            _factBtnCommand ?? (_factBtnCommand = new RelayCommandAsync<OperatorCommandParameter>(FactBtnCommandExecute));

        private void FactBtnCommandExecute(OperatorCommandParameter commandParameter)
        {
