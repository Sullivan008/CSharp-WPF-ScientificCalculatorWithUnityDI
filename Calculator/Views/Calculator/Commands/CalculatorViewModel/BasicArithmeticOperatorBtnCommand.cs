...
namespace Calculator.Views.Calculator.ViewModels
{
    ...
    {
        private ICommand _basicArithmeticOperatorBtnCommand;
        public ICommand BasicArithmeticOperatorBtnCommand =>
            _basicArithmeticOperatorBtnCommand ?? (_basicArithmeticOperatorBtnCommand = new RelayCommandAsync<OperatorCommandParameter>(BasicArithmeticOperatorBtnCommandExecute));

        private void BasicArithmeticOperatorBtnCommandExecute(OperatorCommandParameter commandParameter)
        {
